...
class HotelKfc extends StatefulWidget {
  const HotelKfc({Key? key}) : super(key: key);

  @override
  State<HotelKfc> createState() => _HotelKfcState();
}

class _HotelKfcState extends State<HotelKfc> {
  int quantity = 0;
