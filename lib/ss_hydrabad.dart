...
class HotelSShydrabad extends StatefulWidget {
  const HotelSShydrabad({Key? key}) : super(key: key);

  @override
  State<HotelSShydrabad> createState() => _HotelSShydrabadState();
}

class _HotelSShydrabadState extends State<HotelSShydrabad> {
